        ...
        <div className={`bg-white p-6 rounded-xl shadow-lg w-full max-w-7xl mx-auto border border-gray-200 ${isModalMode ? 'h-full' : ''}`}>
                ...
                <>
                    ...
                    <div className="mb-8 flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0 sm:space-x-8">
                        ...
                        <div>
                            ...
                            <select
                                id="fontFamily"
                                value={templates.find(t => t.id === selectedTemplateId)?.defaultSettings?.fontFamily || 'Inter, sans-serif'}
            ...
            <div className="flex justify-end items-center mt-8 gap-4">
                {isModalMode ? (
                    <button
                        onClick={onClose}
                        className="ml-2 py-2 px-6 text-base font-medium rounded-md text-white"
