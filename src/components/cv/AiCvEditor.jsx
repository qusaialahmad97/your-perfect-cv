...
const AiCvEditor = ({ cvData, setCvData }) => {
  ...
  const handleExecuteRefine = async (prompt) => {
    ...
    try {
      ...
      setRefineModalState({ isOpen: false, fieldName: null, currentValue: '', updateFn: null, isRichText: false });
    }
  };
