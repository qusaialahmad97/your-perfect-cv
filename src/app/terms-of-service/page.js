...
        <p className="mb-4">
          All payments and transactions for the Service are processed through our authorized Merchant of Record, **Paddle**. By purchasing a Pro Subscription, you acknowledge that Paddle acts as the legal reseller of our products, and you are entering into a purchase agreement with Paddle, not directly with Your Perfect CV. By agreeing to these Terms, you also agree to be bound by **<a href="https://www.paddle.com/legal/checkout-buyer-terms" className="text-blue-600 hover:underline">Paddle’s Buyer Terms</a>**, which govern the transaction between you and Paddle.
        </p>
...
          <li><strong>Refunds:</strong> All payments are non-refundable. For more information, please see our dedicated **<a href="/refund-policy" className="text-blue-600 hover:underline">Refund Policy</a>** page.</li>
        </ul>
        <p className="mb-4">
